...
<body>
<h1><center><font face="Agency FB" size="10"color=#FFFFFF><b style=color:#2F4F4F>Travel in thailand</font></center></h1>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div>
                                ...
                                <p><a class="btn btn-info" href="blog.php?article_id=<?php echo $row["id"]; ?>" role="button">อ่านเพิ่มเติม &raquo;</a></p>
                            </div>
                        </div>
                    </div>
                    <br>
